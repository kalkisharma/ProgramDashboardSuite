...
| **v6.0.2** | Dedupe team colors (fix Certification/Powertrain `#ef4444` clash; fallback pool now disjoint from named) + 7 new named teams: Handling Qualities, Loads and Criteria, Rotors, Thermal, Innovations, Airframe, Design (22 named + 16 fallback, all distinct; guard test added) | Done — current |
