...
| **v6.7.1** | Docs/help refresh for the v6.1–6.7 work: in-app help modal (Status Report Variance + RAG-threshold panel editing, Gantt Set Baseline + critical path, Weight Budget contingency, Baseline/Contingency in the Excel-sheets list) + README (Baseline/Weight sheets, RAG/Weight-Unit Project Info keys, Set-Baseline/RAG-threshold actions) + TOUR module map (hierarchy.js, CPM/WBS descriptions) | Done — current |
