...
| **Status Report** | Leadership, PMs | Task table with RAG status (Overdue / At Risk / On Track / Done), POC/Customer + derived teams, three task filters (All Tasks / All Open / Concerns Only), Phase + POC-Team + Customer-Team multi-selects, toggleable columns, and one-click 3-slide PowerPoint export |
