...
| `Schedule` | Yes | Task ID, WBS, Task Name, POC, Customer, Start Date, End Date, % Complete, Dependencies, Milestone (Y/N), Notes — **POC** and **Customer** accept comma-separated names; each is cross-referenced against the Org Chart to derive a team |
...
| **Gantt Chart** | Engineers, PMs | Full WBS schedule with dependency arrows, today line, milestones, zoom, and phase / POC-team filters |
